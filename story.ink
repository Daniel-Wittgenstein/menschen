...
* Sage: "Du zuerst!"
    ...
    ** Gehe nach Hause
        ...
        *** Du denkst: "Was soll's, ich bleib doch hier!"
...
- (backfoyer)
Du findest dich in einem großen Eingangssaal mit Marmorwänden wieder. Bis auf eine ((@bueste Marmorbüste)) und ein halbes Dutzend antiker ((@foyer_gemaelde Gemälde)) an den Wänden ist er vollständig leer. 

Marek ist nirgendwo zu sehen.
